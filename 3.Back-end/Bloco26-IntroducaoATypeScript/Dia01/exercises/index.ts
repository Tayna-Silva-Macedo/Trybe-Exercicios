...
console.log(
  `Losango com diagonais igauis a 32cm e 18cm: ${Exercise.rhombus(32, 18)}cm²`
);
console.log(
  `Losango com diagonais igauis a 200cm e 50cm: ${Exercise.rhombus(200, 50)}cm²`
);
console.log(
  `Losango com diagonais igauis a 75cm e 25cm: ${Exercise.rhombus(75, 25)}cm²`
);
