from src.exercicio2 import translate_to_number
import pytest
...
def test_def_should_be_converted_in_4():
    assert translate_to_number("GHI") == "444"


def test_def_should_be_converted_in_5():
    assert translate_to_number("JKL") == "555"


def test_def_should_be_converted_in_6():
    assert translate_to_number("MNO") == "666"


def test_def_should_be_converted_in_7():
    assert translate_to_number("PQRS") == "7777"


def test_def_should_be_converted_in_8():
    assert translate_to_number("TUV") == "888"


def test_def_should_be_converted_in_9():
...
def test_expression_maximum_are_thirty_chars():
    long_expression = "1111111111111111111111111111111"
